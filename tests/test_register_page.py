...
class TestRegisterPage:
    ...
    def test_register_new_user(self, register_data: dict):
        ...
        register_page: RegisterPage = RegisterPage(self.driver)
    ...
    def test_register_with_missing_required_field_input(self, register_data: dict, missing_field: str):
        """Test case to verify registration fails when a required field is missing."""
        self.driver.get('https://parabank.parasoft.com/parabank/register.htm')
        register_data.pop(missing_field)
        register_page: RegisterPage = RegisterPage(self.driver)
        register_page.register_user(user_data=register_data)
